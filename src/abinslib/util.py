...
def calculate_indirect_q2(energy_transfer: Quantity,
                          angle: float,
                          final_energy: Quantity) -> Quantity:
    ...
    # E = hbar^2 k^2 / 2m
    momentum2_to_energy = Quantity(0.5, 'hbar^2 / neutron_mass').to('meV angstrom^2')
